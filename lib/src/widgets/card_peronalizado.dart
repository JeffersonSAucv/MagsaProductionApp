...
class CardPedidoPersonalizadoWidget extends StatelessWidget {
  final List<Pedidos> pedidos;
  final int index;

  @required
  final String codigopedidotext;
  @required
  final String nombreDistritoText;
  @required
  final String direccionText;
  @required
  final String consultoraNombreText;
  @required
  final String telefConsultoraText;
  @required
  ...
  const CardPedidoPersonalizadoWidget({
    ...
    this.colorbotonaccion2 = null ?? null,
    this.pedidos,
    this.index,
...
/*     final double sizeTextTitle = responsive.inchp(2.5);
    ...
    return Container(
        ...
        child: Stack(
          children: <Widget>[
            TopBackGround(
              color1bg: this.color1bg,
              color2bg: this.color2bg,
              iconbg: this.iconbg,
            ),
            ...
            Row(
              ...
              children: <Widget>[
                SizedBox(
                  height: responsive.heigthp(15),
                  width: responsive.widthp(4),
                ),
                FaIcon(
                  FontAwesomeIcons.hashtag,
                  color: Colors.white,
                  size: responsive.inchp(6),
                ),
                SizedBox(
                  width: responsive.widthp(5),
                ),
                Expanded(
                    child: Text(
                  codigopedidotext,
            ...
            Positioned(
              ...
              child: Container(
                  ...
                  child: (pedidos[index].idEvento.id == "$STATUS_EN_RUTA")
                      ? pedidoEnRutaDetalle(context)
                      : pedidoDetalle(
                          context) //* condicion paa mostrar en los cards
                  ),
            ),
            //BOTONES ACCIONES
            Positioned(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      BottomAccion(
                          titulo: tituloaccion1,
                          onTap: accionboton1tap,
                          colorOnda: Colors.white,
                          colorText: Colors.white,
                          colorboton: colorbotonaccion1),
                      SizedBox(width: responsive.widthp(12)),
                      BottomAccion(
                          titulo: tituloaccion2,
                          onTap: accionboton2tap,
                          colorOnda: Colors.yellow,
                          colorText: Colors.black,
                          colorboton: colorbotonaccion2),
                    ],
                  ),
                ))
          ],
    ...
    return Column(
      ...
      children: <Widget>[
        RichText(
          text: TextSpan(
              style: TextStyle(
                  color: Colors.black, fontFamily: 'OpenSans-Regular'),
              children: [
                TextSpan(
                    text: 'Distrito: ',
                    style: TextStyle(
        ...
        RichText(
          text: TextSpan(
              ...
              children: [
                TextSpan(
                    text: 'Nombre consultora: ',
                    style: TextStyle(
                      fontWeight: FontWeight.w800,
                      fontSize: sizeTextTitle,
                    )),
                TextSpan(
                    text: consultoraNombreText,
                    style: TextStyle(
                      fontWeight: FontWeight.w400,
                      fontSize: sizeTextSubTitle,
                    )),
        ...
        RichText(
          text: TextSpan(
              ...
              children: [
                TextSpan(
                    text: 'Telf. consultora: ',
                    style: TextStyle(
                      fontWeight: FontWeight.w800,
                      fontSize: sizeTextTitle,
                    )),
                TextSpan(
                    text: telefConsultoraText,
                    style: TextStyle(
                      fontWeight: FontWeight.w400,
                      fontSize: sizeTextSubTitle,
                    )),
    ...
    return ClipRRect(
      ...
      child: Material(
        ...
        child: FlatButton(
          ...
          child: Ink(
            decoration: BoxDecoration(color: colorboton),
            child: Container(
